...
{
    DirectX::XMFLOAT2 uv;
    uv.x = static_cast<float>(pValue[0]);
    uv.y = static_cast<float>(pValue[1]);
    return uv;
}
...
{
    DirectX::XMFLOAT4 v;
    v.x = static_cast<float>(pValue[0]);
    v.y = static_cast<float>(pValue[1]);
    v.z = static_cast<float>(pValue[2]);
    v.w = 1.0f;
    return v;
}
