...
public:
	...
	bool LeftJustPressed() noexcept;
	bool RightIsPressed() const noexcept;
	bool RightJustPressed() noexcept;
	bool MiddleIsPressed() const noexcept;
	bool MiddleJustPressed() noexcept;
...
private:
	...
	bool leftIsPressed_old = false;    // 左ボタン押下状態
	bool rightIsPressed_old = false;   // 右ボタン押下状態
	bool middleIsPressed_old = false;  // 中ボタン押下状態
